      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '12px 16px 12px' }}>
          ...
          <button
            ...
            className="w-11 h-11 rounded-full bg-white/50 dark:bg-[#2C2C2E]/50 flex items-center justify-center text-[#424242] dark:text-white active:opacity-60 transition-opacity"
          >
          ...
          <div className="px-4 space-y-3 pb-10">
            ...
            {sub.next_billing_date && (
              <div className="bg-[#F7F8FA] dark:bg-[#232325] rounded-2xl border border-[#F0F0F0] dark:border-[#2C2C2E] px-4 py-4">
                ...
                {/* Countdown */}
                <p className="text-xs font-semibold text-[#424242] dark:text-[#F2F2F7] mt-2">{daysLabel}</p>
              </div>
            )}
