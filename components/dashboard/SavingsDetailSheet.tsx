  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          <p className="text-[17px] font-bold text-[#000000] dark:text-[#F2F2F7]">{name}</p>
      ...
      <div className="flex items-center justify-between mb-2">
        <p className="text-[13px] font-semibold text-[#000000] dark:text-[#F2F2F7]">{t('savings.ifAnnual')}</p>
        ...
        {names.map((name, i) => (
          <div key={name} className="flex items-center gap-3 py-2 border-b border-[#F5F5F5] dark:border-[#2C2C2E] last:border-0">
            <SubscriptionAvatar
              ...
              corner="rounded-[6px]"
            />
            <span className="flex-1 text-[14px] text-[#000000] dark:text-[#F2F2F7]">{name}</span>
            {i === 0 && (
  ...
  return (
    <>
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          <p className="text-[17px] font-bold text-[#000000] dark:text-[#F2F2F7]">{t('savings.bundleTitle')}</p>
